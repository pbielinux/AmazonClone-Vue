  ...
  <footer>
    <div class="navLeftFooter">
      ...
      <div class="navFooterCopyright">
        <ul>
          <li>
            <a href="https://www.pbielinux.com" class="nav_a">PBileinux.com</a>
          </li>
          <li class="nav_last">2021, Portfolio Project</li>
        </ul>
          <p class="nav_last">This website is not related with Amazon.com.</p>
      </div>
    </div>
  </footer>
  <!--/FOOTER-->
