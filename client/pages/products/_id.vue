	...
	<main>
		...
		<div class="container-fluid">
			<div class="wayfinding-breadcrumbs-container">
				<ul class="a-unordered-list a-horizontal a-size-normal">
					<li>
		...
		<div class="container-fluid">
			<div class="dp-container">
				<!-- Product Row -->
				<div class="row">
					<!-- First 3 grid - Product Img &  Author's section -->
					<div class="col-lg-3 col-md-3 col-sm-4">
						...
						<div class="leftCol">
							...
							<div class="imgBlock">
								<div class="ebooksimg">
									<img src="/img/featuredProduct.jpg" alt="{ product.title } photo" class="img-fluid">
								</div>
							</div>
						...
						<div class="centerCol">
							...
							<div class="titleDiv">
								<h1 class="productTitle">
									...
									<span class="smallTitle">{ Product Category }</span>
								</h1>
							</div>
							<!-- Author's Name -->
							<div class="bylineinfo">
								by
								<a href="#" class="authorName">{ Author's Name }
											...
											<span class="a-list-item">
												<span class="a-button-toggle">
													<span class="a-button-inner">
														<a href="#" class="a-button-text">
															<span>
																<img src="/img/audibleLogo.png" alt="Audible logo" class="img-fluid" style="width: 20px;">
																Audible
															</span>
															<br>
															<span class="a-color-secondary">-</span>
					...
					<div class="col-lg-3 col-md-3 col-sm-6">
						...
						<!-- Read on An device Image-->
						<div class="kcpAppBaseBox text-center">
							<img src="/img/readyondevice.png" alt="Read on any Device" class="img-fluid">
						</div>
					</div>
				</div>
				<br>
				...
				<div class="books-entity-teaser">
					<div class="bucket">
						...
						<div class="content">
							<div class="row">
								<!-- Author Image & Follow Button -->
								<div class="col-md-2 col-sm-4 col-4">
									<div class="authorContent">
										<div class="authorImageSingle">
											<a href="#">
												<img src="/img/featuredProduct.jpg" alt="{ Product Author } photo" class="img-fluid">
											</a>
										</div>
										<div class="authorFollow">
								...
								<div class="col-md-10 col-sm-8 col-8 pl-0">
									<div class="mainContent">
										<h3>Biography</h3>
										<div id="authorBio">My name is Heisenberg</div>
									</div>
								</div>
							</div>
						</div>
